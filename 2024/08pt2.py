    ...
    for j in range(length):
        ...
        for k in range(len(node_types[element])):
            ...
            while True:
                offset[0] += d_v[0]
                offset[1] += d_v[1]
                if cur_y + offset[0] < 0 or cur_y + offset[0] >= len(grid) or cur_x + offset[1] < 0 or cur_x + offset[1] >= len(grid[0]): break
                if [cur_y + offset[0],cur_x + offset[1]] != [test_y,test_x] and [cur_y + offset[0],cur_x + offset[1]] != [cur_y,cur_x]:
            ...
            while True:
                ...
                if [cur_y + offset[0],cur_x + offset[1]] != [test_y,test_x] and [cur_y + offset[0],cur_x + offset[1]] != [cur_y,cur_x]:
                    anti_tests.append([cur_y + offset[0],cur_x + offset[1]])
            anti_tests.append([cur_y,cur_x])
            anti_tests.append([test_y,test_x])
